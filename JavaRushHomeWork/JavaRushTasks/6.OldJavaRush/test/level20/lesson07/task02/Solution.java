...
//    {
//        ObjectOutputStream objectOutputStream = new ObjectOutputStream(new FileOutputStream(new File("D:\\Hotj\\Dropbox\\JAVA\\JavaRushHomeWork\\JavaRushHomeWork\\src\\com\\javarush\\test\\level20\\lesson07\\task02\\file.tmp")));
//
//        OutputToConsole ssO = new OutputToConsole();
//        objectOutputStream.writeObject(ssO);
//        objectOutputStream.close();
//
//        ObjectInputStream objectInputStream = new ObjectInputStream(new FileInputStream("D:\\Hotj\\Dropbox\\JAVA\\JavaRushHomeWork\\JavaRushHomeWork\\src\\com\\javarush\\test\\level20\\lesson07\\task02\\file.tmp"));
//        OutputToConsole ddO = (OutputToConsole) objectInputStream.readObject();
//        objectInputStream.close();
//
//        ddO.outputToConsole(1);
//    }
    /**
    ...
    public static class OutputToConsole implements Externalizable {
        ...
        /**
         * Outputs to the console a static field of index.html class [greeting].
