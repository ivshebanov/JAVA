...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            String your_file_name = "D:\\Hotj\\Dropbox\\JAVA\\JavaRushHomeWork\\JavaRushHomeWork\\src\\com\\javarush\\test\\level20\\lesson02\\task01\\file";
    ...
    public static class Human {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            if (isAssets.equals("yes")){
                String sAssets = reader.readLine();
                while (!sAssets.equals("end")){
                    this.assets.add(new Asset(sAssets));
                    sAssets = reader.readLine();
                }
