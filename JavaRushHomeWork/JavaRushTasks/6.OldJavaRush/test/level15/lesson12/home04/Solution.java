...
4. В статическом блоке класса index вызвать метод readKeyFromConsoleAndInitPlanet.
...
public class Solution {
    ...
    public static void readKeyFromConsoleAndInitPlanet() {
        ...
        try {
            ...
            if (par.equals(Planet.EARTH)) thePlanet = Earth.getInstance();
            if (par.equals(Planet.MOON)) thePlanet = Moon.getInstance();
