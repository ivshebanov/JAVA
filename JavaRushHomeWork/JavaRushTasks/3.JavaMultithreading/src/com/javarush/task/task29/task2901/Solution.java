...
public class Solution {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        if (solution.isFileLoaded()) {
            System.out.println(solution.hasFileExpectedLine(
                    "public class Solution {"));   //expected true
            System.out.println(solution.hasFileExpectedLine(
                    " public class Solution {"));  //expected false
        }
    }
    ...
    public void downloadFileContent() {
        try {
            contentAsLines = Files.readAllLines((new File(localFileName))
