...
public class Solution {
    ...
    public Solution(int value1, String value2, Date value3) {
        logger.info("test");
        logger.debug("Solution value1 = " + value1 + ", value2 = " + value2 + ", Date" + value3);
        this.value1 = value1;
        this.value2 = value2;
        this.value3 = value3;
    }
    ...
    public static void main(String[] args) {
        Solution solution = new Solution(12, "3425", new Date());
        solution.calculateAndSetValue3(1);
        solution.printString();
        solution.printDateAsLong();
        solution.divide(12, 3);
    ...
    public void divide(int number1, int number2) {
        ...
        try {
            ...
            logger.error("divide ArithmeticException: " + e);
        }
    }
